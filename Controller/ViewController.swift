...
class ViewController: UIViewController {
    ...
    private var moneyView = SaveMoneyViewController()
    ...
    private lazy var moneyButtons: [UIButton] = {
        ...
        for state in buttonsStates {
            ...
            button.setTitleColor(Constants.Color.blackColor, for: .normal)
    ...
    private let countButton: UIButton = {
        ...
        button.addTarget(ViewController.self, action: #selector(didTapButton), for: .touchUpInside)
        return button
    }()

    @objc private func didTapButton() {
        let rootVC = moneyView
